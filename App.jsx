...
function App() {
  ...
  return (
    ...
    <div className="row p-4 pb-0 pe-lg-0 pt-lg-5 align-items-center rounded-3 border shadow-lg">
      <div className="col-lg-7 p-3 p-lg-5 pt-lg-3">
        <h1 className="display-4 fw-bold lh-1 text-body-emphasis">Atomic Habits: Perubahan Kecil yang Memberikan hasil luarbiasa</h1>
        <p className="lead">cara mudah dan terbukti untuk membentuk kebiasaan buruk menjadi lebih baik lagi</p>
  ...
  <footer className="py-3 my-4">
    ...
    <p className="text-center text-body-secondary">&copy; 2025 Reza Lucky Ermawan</p>
  </footer>
</div>
  </div>
    </>
